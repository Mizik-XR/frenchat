...
@echo off
chcp 65001 >nul
title Lancement FileChat - Mode Simple
...
REM Définir le mode cloud par défaut (plus simple)
set "MODE_CLOUD=1"
set "CLIENT_MODE=1"
set "HIDE_DEBUG=1"
...
if not exist "dist\" (
    ...
    if errorlevel 1 (
        ...
        echo.
        echo Essai de réparation automatique...
        call fix-blank-page.bat
        if errorlevel 1 (
            echo [ERREUR] Impossible de démarrer FileChat.
            echo.
            pause
            exit /b 1
        )
